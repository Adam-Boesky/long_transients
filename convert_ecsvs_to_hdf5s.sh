...
#SBATCH -o /n/holystore01/LABS/berger_lab/Users/aboesky/long_transients/file_conversion_logs/myoutput_\%j.out           # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /n/holystore01/LABS/berger_lab/Users/aboesky/long_transients/file_conversion_logs/myerrors_\%j.err           # File to which STDERR will be written, %j inserts jobid
