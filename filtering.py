...
def filter_tables():
    ...
    with schemdraw.Drawing() as d:
        ...
        # Delta mag > n sigma
        dmag_sigma = 5
        tabs, bin_means, bin_stds = filters.filter(tabs, 'only_big_dmag', mag_thresh=dmag_sigma)
    ...
    with schemdraw.Drawing() as d:
        ...
        for band, srcs in sources_in_both.items():
            srcs.save(f'/Users/adamboesky/Research/long_transients/Data/filter_testing/1_in_both_{band}_pre_gaia.ecsv')
        ...
        for band, srcs in sources_in_ztf.items():
            srcs.save(f'/Users/adamboesky/Research/long_transients/Data/filter_testing/1_in_ztf_{band}_pre_gaia.ecsv')
        ...
        # Save the image
        d.save(f'Figures/1_filtering_flowchart.pdf')
        for band, srcs in sources_in_ztf.items():
            srcs.save(f'/Users/adamboesky/Research/long_transients/Data/filter_testing/1_{band}.ecsv')
    ...
    with schemdraw.Drawing() as d:
        ...
        # TESTING!!!
        for band, srcs in sources_in_both.items():
            srcs.save(f'/Users/adamboesky/Research/long_transients/Data/filter_testing/2_in_both_{band}_pre_gaia.ecsv')
        ...
        for band, srcs in sources_in_pstarr.items():
            srcs.save(f'/Users/adamboesky/Research/long_transients/Data/filter_testing/2_in_ztf_{band}_pre_gaia.ecsv')
        ...
        # Save the image
        d.save(f'Figures/2_filtering_flowchart.pdf')
        for band, srcs in sources_in_pstarr.items():
            srcs.save(f'/Users/adamboesky/Research/long_transients/Data/filter_testing/2_{band}.ecsv')
